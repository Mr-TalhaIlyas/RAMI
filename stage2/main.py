...
#%%
# cpth = f'/home/talha/Data/mme/gp_test/fusion_modules/chkpt/mfi1.pth'
cpth = f'/home/user01/Data/mme/time_exps/fusion_modules/chkpt/gp_rag{config["num_fold"]}.pth'
# cpth = f'/home/talha/Data/mme/gp_test/fusion_modules/chkpt/cmft5.pth'
# cpth = f'/home/user01/Data/mme/gp_test/fusion_modules/chkpt/cat{config["num_fold"]}.pth'
...
for feature in ['all']:#, 'ecg', 'pose_flow']:
    print(30*'=')
