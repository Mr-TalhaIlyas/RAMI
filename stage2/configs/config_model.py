...
pretrained_root_dir = '/home/talha/Data/mme/scripts/models/pretrained/'

mme = dict(
            batch_size= 8,

            num_sub_classes = 5,
            num_sup_classes = 1,#3, # wiht sigmoid activation output
            
            fusion_type = 'mfi', # 'cat', 'trans', 'graph', 'cmft'
            ...
            body_pretrainned_chkpts= None, #f"{pretrained_root_dir}gcn_body_17kpts_kinetic400.pth",
            ...
            ewt_pretrainned_chkpts=None, #f'{pretrained_root_dir}ecg_vit_fold1flip.pth',
