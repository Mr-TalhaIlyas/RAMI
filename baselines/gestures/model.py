...
def ResNet2plus1D(frames_per_clip, remove_fc=True):
...
# data = torch.randn((4,16,512))
# model = TCN(out_classes=2, num_inputs=16, num_blocks=2, num_hidden_units=64)
# # model = RecurrentModel(bidirectional=True, hidden_units=64)
# # model = MeanModel()
# y = model(data)
